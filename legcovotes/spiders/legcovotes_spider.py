...
class LegcoVotesXMLFileSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        for vote in votes:
            ...
            councilvote["result"] = vote.xpath('vote-summary/overall/result/text()').extract()    
            councilvote["functional_present"] = vote.xpath('vote-summary/functional-constituency/present-count/text()').extract()    
            councilvote["functional_vote"] = vote.xpath('vote-summary/functional-constituency/vote-count/text()').extract()  
            councilvote["functional_yes"] = vote.xpath('vote-summary/functional-constituency/yes-count/text()').extract()  
            councilvote["functional_no"] = vote.xpath('vote-summary/functional-constituency/no-count/text()').extract()  
            councilvote["functional_abstain"] = vote.xpath('vote-summary/functional-constituency/abstain-count/text()').extract()  
            councilvote["functional_result"] = vote.xpath('vote-summary/functional-constituency/result/text()').extract()  
            councilvote["geographical_present"] = vote.xpath('vote-summary/geographical-constituency/present-count/text()').extract()  
            councilvote["geographical_vote"] = vote.xpath('vote-summary/geographical-constituency/vote-count/text()').extract()  
            councilvote["geographical_yes"] = vote.xpath('vote-summary/geographical-constituency/yes-count/text()').extract()  
            councilvote["geographical_no"] = vote.xpath('vote-summary/geographical-constituency/no-count/text()').extract()  
            councilvote["geographical_abstain"] = vote.xpath('vote-summary/geographical-constituency/abstain-count/text()').extract()  
            councilvote["geographical_result"] = vote.xpath('vote-summary/geographical-constituency/result/text()').extract()  
